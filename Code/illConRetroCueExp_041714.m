...
pathOut = '/Volumes/C-Lab/Google Drive/Lab Projects/Feature Binding/Data/Updated Timing/';
...
for n=1:numTrials
    ...
    [rawdata(n,5), rawdata(n,6), rawdata(n,4), letResponse(n), colResponse(n), numResponse(n), numResponseChoice(:,n)] = ResponseRetroCue(w,rect,dev_ID,(letters{letterPosition(n,whichLetterVal)}),(colors{colorPosition(n,whichLetterVal)}),numVal(n,:));
...
save(sprintf('%s%s',pathOut,datafile_full));
